...
void *customer(void *number) {
    ...
    sleep(5);
    printf("Customer %d arrived at barber shop.\n", num); // Wait for space to open up in the waitingroom...
...
void *barber(void *junk){
    ...
    // While there are still customers to be serviced... Our barber is omnicient and can tell if there arecustomers still on the way to his shop.
